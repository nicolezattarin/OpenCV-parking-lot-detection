...
parser.add_argument('--ndata', help='number of images to use', default= 50, type=int)
parser.add_argument('--camera_number', help='camera number', default=2, type=int)
parser.add_argument('--weather', help='weather', default= 'cloudy', type=str)
